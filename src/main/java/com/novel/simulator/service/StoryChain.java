...
public class StoryChain {
    ...
    public String generateEnding(UserSession session, UserCharacter character) {
        ...
        throw new RuntimeException("LLM 未配置，无法生成结局。请检查 LLM API Key。");
    }
    ...
    private String generateStoryWithResolution(UserSession session, Node currentNode,
        ...
        userContent.append("你选择了「").append(resolution.getChoiceLabel() != null ? resolution.getChoiceLabel() : "").append("」(")
            .append(resolution.getRiskLevel() != null ? resolution.getRiskLevel() : "").append(")\n\n");
